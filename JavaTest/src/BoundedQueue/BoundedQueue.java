...
{
    // Overview:  a BoundedQueue.BoundedQueue is a mutable, bounded FIFO data structure
    ...
    {
        if (capacity < 0)
            throw new IllegalArgumentException ("BoundedQueue.BoundedQueue.constructor");
    ...
    {  // Modifies: this
        ...
        if (o == null)
            throw new NullPointerException ("BoundedQueue.BoundedQueue.enQueue");
        else if (size == capacity)
            throw new IllegalStateException ("BoundedQueue.BoundedQueue.enQueue");
        else
        {
            size++;
            elements [back] = o;
    ...
    {  // Modifies: this
        ...
        if (size == 0)
            throw new IllegalStateException ("BoundedQueue.BoundedQueue.deQueue");
        else
        {
            size--;
